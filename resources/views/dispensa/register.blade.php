...
@section('content')
    <h3 class="ms-5 me-5">Nova despesa</h3>
    <nav class="ms-5 me-5" style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item ms-1 me-1 active" aria-current="page"><a href="{{ route('dispensa.index') }}"><i
                        class="bi bi-people me-1"></i>Lista de despesa</a></li><i class="bi bi-chevron-right"></i>
            <li class="breadcrumb-item ms-1 me-1 active" aria-current="page"><i class="bi bi-plus-lg me-2"></i>Nova despesa
            </li>
        </ol>
    </nav>
    <div class="card ms-5 me-5" style="border-radius:10px;">
        ...
        <div class="card-body">
            <form method="POST" action="{{ action('App\Http\Controllers\DispensaController@store') }}">
                @csrf
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <select name="modalidade" style="width: 100%"
                            ...
                            <option value="Concorrência" @if (old('modalidade') == 'Concorrência') selected @endif>Concorrência
                            </option>
                            <option value="Dispensa" @if (old('modalidade') == 'Dispensa') selected @endif>Dispensa</option>
                            <option value="Inexigibilidade" @if (old('modalidade') == 'Inexigibilidade') selected @endif>Inexigibilidade</option>
                            <option value="Pregão" @if (old('modalidade') == 'Pregão') selected @endif>Pregão</option>
                            <option value="Tomada de preço" @if (old('modalidade') == 'Tomada de preço') selected @endif>Tomada de
                                preço</option>
                    ...
                    <div class="col mb-2">
                        ...
                        <input id="discriminacao" type="text"
                            ...
                            @error('discriminacao') autofocus @enderror name="discriminacao"
                            value="{{ old('discriminacao') }}" placeholder="Informe a discriminação do item" required
                            autocomplete="discriminacao">
                ...
                <div class="row" >
                    <div class="col mb-2">
                        ...
                        <input type="text" name="sub_classe_cnae" id="sub_classe_cnae" style="width: inherit"
                            ...
                            @error('sub_classe_cnae') autofocus @enderror value="{{ old('sub_classe_cnae') }}"
                        ...
                        <div id="dropDownCnae" class="dropDownCnae" style="position: absolute; max-height: 120px;">
                ...
                <div class="row">
                    ...
                    <div class="col mb-2">
                        ...
                        <select name="grupo_despesa" style="width: 100%"
                            ...
                            <option value="Compras e Serviços" @if (old('grupo_despesa') == 'Compras e Serviços') selected @endif>
                                Compras e
                                Serviços</option>
                            <option value="Obras, serv. Engenharia e veículos"
                                @if (old('grupo_despesa') == 'Obras, serv. Engenharia e veículos') selected @endif>Obras, serv. eng. e veí.</option>
                    ...
                    <div class="col mb-2">
                        <label for="valor" class="col-form-label" title="Valor da dispensa">{{ __('Valor *') }}</label>

                        <div class="md-6">
                            <input id="valor" type="text"
                                class="form-control @error('valor') is-invalid @enderror"
                                @error('valor') autofocus @enderror name="valor" value="{{ old('valor') }}"
                    ...
                    <div class="col mb-2">
                        ...
                        <div class="md-6">
                            <input id="numero_dispensa" type="text"
                                ...
                                @error('numero_dispensa') autofocus @enderror name="numero_dispensa"
                                value="{{ old('numero_dispensa') }}" placeholder="Informe o número da despesa" required
                                autocomplete="numero_dispensa">
                    ...
                    <div class="col mb-2">
                        ...
                        <div class="md-6">
                            <input id="numero_processo_licitatorio" type="text"
                                ...
                                @error('numero_processo_licitatorio') autofocus @enderror
                                name="numero_processo_licitatorio" value="{{ old('numero_processo_licitatorio') }}"
